#!/usr/bin/env python3
"""Build the deterministic reader-first Zenodo package for checkpoint 14/29."""
...
EXPECTED = {
    "translated_pages": 14,
    "reader_files": 44,
    "reader_bytes": 2_471_964,
    "reader_manifest_sha256": "7f00470344a634c3cffe0eb3893690a10784f0894baca9a3fb1bc68418d5dae2",
    "pdf_pages": 173,
    "pdf_bytes": 73_828_250,
    "pdf_sha256": "0b6dfa8384eec9a73cb8a489fd2e47c9052eaf33a899b04a21641a8300d3b5af",
    "entities": 6_567,
    "entities_sha256": "1ead2d873ca66b346e8d326d0391de17060f2cbf9664cf84b159c1b6bed66c40",
    "relations": 9_035,
    "relations_sha256": "b235f4d4d724c7fe8653dfd06b075b2225cc2d116f3b87d0fda950d47030159a",
    "translated_entities": 3_777,
}
...
def translated_rows() -> list[dict[str, str]]:
    ...
    if completed[-1]["source_path"] != "random/point/Bayes.html":
        raise RuntimeError("translated boundary no longer ends at Bayes.html")
...
def reader_entries() -> tuple[dict[str, Path], dict[str, object]]:
    ...
    evidence = [
        ...
        ROOT / "00_control" / "CHECKPOINT_2026-08-22_FOURTEEN_PAGE.md",
        ROOT / "00_control" / "LIVE_BROWSER_QA_2026-08-22_FOURTEEN_PAGE.json",
        ROOT / "00_control" / "GITHUB_PUBLICATION_RECEIPT_2026-08-22_FOURTEEN_PAGE.json",
    ]
...
def source_entries(rows: list[dict[str, str]]) -> dict[str, Path]:
    ...
    scripts = [
        ...
        "package_zenodo_checkpoint_v14.py",
...
def build_outputs() -> tuple[dict[Path, bytes], dict[str, object]]:
    ...
    release = {
        ...
        "checkpoint": {
            "complete": False,
            "last_page": "random/point/Bayes.html",
            "next_page": "random/point/Unbiased.html",
        ...
        "github": {
            "content_release": "https://github.com/KokunoYumeto/mathematical-statistics-id/releases/tag/v2026.08.22.14",
