...
LINE_REPLACEMENTS: dict[int, str] = {
    ...
    248: r'''<p>Jadi, kita tidak seharusnya terlalu terpaku pada sifat tak bias. Bagi kebanyakan distribusi asal sampel, tidak akan ada statistik \(U\) dengan sifat bahwa \(U\) merupakan penduga tak bias bagi \(\sigma\) dan \(U^2\) merupakan penduga tak bias bagi \(\sigma^2\).</p>''',
    ...
    367: r'''\t<p class="app">Dalam <a href="JavaScript:openAncillary('../apps/MeanEstimate.html')" class="ancillary">eksperimen rata-rata sampel</a>, tetapkan distribusi asal sampel menjadi gamma. Tingkatkan ukuran sampel dengan bilah geser dan amati secara grafis maupun numerik sifat tak bias dan konsistennya. Jalankan eksperimen sebanyak 1.000 kali dan bandingkan rata-rata sampel dengan rata-rata distribusi.</p>''',
