...
T.update({
    ...
    411: '<p>Andaikan sekarang @@M1@@ dimodelkan oleh variabel acak @@M2@@ yang mempunyai distribusi normal prior dengan rata-rata @@M3@@ dan varians @@M4@@. Seperti biasa, @@M5@@ dan @@M6@@ dipilih untuk menyatakan pengetahuan awal tentang @@M7@@. Kasus khusus yang menarik terjadi ketika @@M8@@, sehingga varians distribusi prior @@M9@@ sama dengan varians distribusi asal sampel yang mendasari.</p>',
