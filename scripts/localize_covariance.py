...
LINE_REPLACEMENTS = {
    ...
    9: r'''\t<meta name="keywords" content="probabilitas, statistika, sampel acak, kovarians sampel, korelasi sampel, regresi linear, diagram pencar, penduga tak bias">''',
    ...
    436: r'''<p>Perhatikan bahwa korelasi antara rata-rata sampel sama dengan korelasi distribusi asal sampel yang mendasarinya. Secara khusus, korelasi tersebut tidak bergantung pada ukuran sampel \(n\).</p>''',
    ...
    494: r'''\t<p class="dfn">Penduga alami bagi kovarians distribusi \(\delta = \cov(X, Y)\) ketika rata-rata distribusi diketahui adalah <dfn>kovarians sampel khusus</dfn>''',
    ...
    547: r'''<p>Karena korelasi sampel \(R(\bs{X}, \bs{Y})\) merupakan fungsi nonlinear dari kovarians sampel dan simpangan baku sampel, secara umum statistik ini bukan penduga tak bias bagi korelasi distribusi \(\rho\). Dalam kebanyakan kasus, bahkan rata-rata dan varians \(R(\bs{X}, \bs{Y})\) akan sulit dihitung. Meskipun demikian, kita dapat menunjukkan konvergensi korelasi sampel menuju korelasi distribusi.</p>''',
    ...
    592: r'''\t<p class="math">\(\var[S(\bs{X}, \bs{Y})] \to 0\) ketika \(n \to \infty\), sehingga kovarians sampel merupakan penduga <dfn>konsisten</dfn> bagi kovarians distribusi.</p>''',
    ...
    623: r'''<p>Fakta bahwa garis regresi sampel dan galat kuadrat rata-rata sepenuhnya analog dengan garis regresi distribusi dan galat kuadrat rata-rata merupakan hal yang elegan dan meyakinkan secara matematis. Sekali lagi, koefisien garis regresi sampel dapat dipandang sebagai penduga bagi koefisien yang bersesuaian pada garis regresi distribusi.</p>''',
