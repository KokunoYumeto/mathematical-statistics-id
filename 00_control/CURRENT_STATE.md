...
Variance preserves 827 source elements in the exact hierarchy, 47 units, 39
disclosures, 583 delimited TeX spans plus three raw math environments, 64 IDs,
and three byte-identical raw script/style blocks. Nineteen protected correction
categories account for 21 raw/TeX repairs; 30 exact href-delta entries account
for 40 occurrences, including three occurrence-specific source-link repairs.
The aggregate QA census is 2,694 source elements, 154 units, 112 disclosures,
1,711 delimited TeX spans, 237 IDs, 162 local references, and 31 fragments.
...
Covariance preserves the exact 906-element source hierarchy, 58 units, 34
disclosures, 795 TeX spans, three raw script/style blocks, and 80 IDs. Thirty-one
protected math-span repairs, one TeX-text localization, and five raw-TeX
repairs are explicitly declared. Its 23 href-delta entries / 32 occurrences
include two occurrence-specific source-fragment repairs. Six frozen figures /
69,956 bytes close its direct image dependencies. The aggregate QA census is
4,446 source elements, 263 units, 180 disclosures, 3,075 TeX spans, 390 IDs,
287 local references, and 69 fragments. Language, mathematical, exact-data,
...
`CHECKPOINT_2026-08-22_ELEVEN_PAGE.md`. The exact narrow content commit is
...
Variance repairs include the sample-size and nondegeneracy conditions,
covariance formula/index corrections, data-summary recomputations, exercise
...
Covariance repairs cover malformed notation and derivations, the missing
regression `n-1` factors, the population prediction-error identity, omitted
